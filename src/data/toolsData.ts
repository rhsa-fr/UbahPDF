...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Ekstrak konten dokumen PDF menjadi format Markdown (.md) lengkap dengan deteksi heading dan list.',
    iconName: 'FileCode',
    category: 'pdf',
    color: '#0284c7',
  ...
  },
  {
    ...
    description: 'Konversi dokumen Word DOCX menjadi format Markdown (.md) bersih dengan struktur heading, list, dan tabel.',
    iconName: 'FileText',
    category: 'office',
    color: '#2563eb',
